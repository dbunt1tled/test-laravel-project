        ...
        <div class="d-flex flex-row mb-3">
            ...
            @if ($advert->isOnModeration())
                <form method="POST" action="{{ route('admin.adverts.adverts.moderate', $advert) }}" class="mr-1">
                    @csrf
                    <button class="btn btn-success">Модерировать</button>
                </form>
            @endif
        ...
        <div class="col-md-9">
            ...
            <p>
                @if ($advert->expires_at)
                    Дата: {{ $advert->published_at }} &nbsp;
                @endif
                @if ($advert->expires_at)
                    Истекает: {{ $advert->expires_at }}
                @endif
            </p>
            ...
            <div class="d-flex flex-row mb-3">
                ...
                <span class="btn btn-primary phone-button mr-1" data-source="{{ route('adverts.phone', $advert) }}"><span class="fa fa-phone"></span> <span class="number">Показать номер телефона</span></span>
            ...
            <div class="h3">Подобные объявления</div>
