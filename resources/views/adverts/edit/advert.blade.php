...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Редактировать объявление</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" class="form-control {{ $errors->has('title')? 'is-invalid':'' }}" name="title" value="{{ old('title', $advert->title) }}" required>
                                            @if($errors->has('title'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="price" class="form-control {{ $errors->has('price')? 'is-invalid':'' }}" name="price" value="{{ old('price', $advert->price) }}" required>
                                            @if($errors->has('price'))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="address" class="form-control {{ $errors->has('address')? 'is-invalid':'' }}" name="address" value="{{ old('address', $advert->address) }}" required>
