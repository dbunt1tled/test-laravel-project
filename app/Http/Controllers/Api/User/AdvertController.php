...
class AdvertController extends Controller
{
    ...
    public function show(Advert $advert)
    {
        ...
        return new AdvertListResource($advert);
    }
    public function store(CreateRequest $request, Category $category,Region $region = null)
    {
        ...
        return (new AdvertListResource($advert))->response()->setStatusCode(Response::HTTP_CREATED);
    }
    ...
    public function update(EditRequest $request, Advert $advert)
    {
        ...
        return new AdvertListResource(Advert::findOrFail($advert->id)->first());
    }
